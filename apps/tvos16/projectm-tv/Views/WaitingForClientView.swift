...
/// Full-screen "Pair with iPhone" overlay. Shown on launch and whenever no AppleJax
...
struct WaitingForClientView: View {
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 32) {
                VStack(spacing: 6) {
                    Text("appleJax Control")
                        .font(.system(size: 60, weight: .bold))
                    Text("Scan with the appleJax Control app on your iPhone")
                        .font(.title3)
